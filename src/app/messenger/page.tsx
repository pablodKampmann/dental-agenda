    ...
    return (
        <div className='overflow-hidden h-screen flex-1'>
            {isLoad ? (
                ...
                //                                             {patient.num ? <p>WhatsApp</p> : <p>-</p>}
                //                                         </td>
                //                                         <td className="whitespace-nowrap text-black">
                //                                             {patient.email ? <p>Email</p> : <p>-</p>}
                //                                         </td>
                //                                     </tr>
                //                                 ))}
                ...
                //                                         <td colSpan={3}>Número de pacientes: {listPatients.length}</td>
                //                                     </tr>
                //                                 )}
                ...
                //                         {patientSelected.address ? <p>Domicilio: {patientSelected.address}</p> : <p>Domicilio -</p>}
                //                     </div>
                //                     <div className='border-2 bg-white shadow-lg px-2 text-xs font-medium py-1 border-gray-600 rounded-lg mt-2 text-black'>
                //                         {patientSelected.num ? <p>Núm: {patientSelected.num}</p> : <p>Núm -</p>}
                //                         {patientSelected.email ? <p>Email: {patientSelected.email}</p> : <p>Email -</p>}
                //                     </div>
                //                     <div className='border-2 bg-white shadow-lg px-2 text-xs font-medium py-1 border-gray-600 rounded-lg mt-2 text-black'>
                //                         Obra Social: {patientSelected.insurance}
                //                         {patientSelected.plan ? <p>Plan: {patientSelected.plan}</p> : <p>Plan -</p>}
                //                         {patientSelected.affiliateNum ? <p>Núm. Afiliado: {patientSelected.affiliateNum}</p> : <p>Núm. Afiliado -</p>}
                //                     </div>
