        ...
        <div className='flex-col mt-2'>
                    ...
                    <div className='flex ml-auto'>
                        {loadObservations ? (
                            ...
                            <div className='flex mr-6 mt-3 mb-1 justify-between'>
                                <div>
                                    <div className='flex justify-center mr-2 bg-teal-500 rounded-md px-1 py-0.5 h-fit mt-3.5'>
                                ...
                                <textarea value={observationsContent} onBlur={() => setShowCancel(false)} onFocus={() => setShowCancel(true)} onChange={(e) => setObservationsContent(e.target.value)} placeholder='Vacío' className='resize-none bg-transparent p-1 border-teal-500 border-2 w-68 h-full rounded-md focus:outline-none focus:border-teal-100 focus:border-dashed text-sm'></textarea>
                            </div>
                        )}
                        <div className='flex-col mt-2'>
            ...
            <div className='flex justify-center items-center mb-2 '>
                ...
                <Link prefetch={true} href={`/patients/${patient.id}/clinicHistory`}>
                    <button onClick={() => setSelectedField('clinicHistory')} className={`${selectedField === 'clinicHistory' ? 'bg-teal-500 border-teal-200' : 'bg-gray-500 hover:bg-teal-900'}  shadow-lg border-x-2 py-1 focus:outline-none border-teal-500 text-white text-md font-semibold transition duration-300 px-3 select-none`}>Historia Clinica</button>
                </Link>
