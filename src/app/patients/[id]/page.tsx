              ...
              <div>
                ...
                <div className='flex mt-8 transition duration-300'>
                  <div className='mr-4 border-4 rounded-3xl border-gray-600 bg-gray-400 bg-opacity-30 shadow-xl w-1/2 relative'>
                    <div className="absolute top-0 right-0 mt-2 mr-2 bg-teal-950 bg-opacity-80 rounded-full w-24 h-24 flex justify-center items-center shadow-xl">
                    ...
                    <div className='flex mb-4'>
                      <div>
                        ...
                        <div onClick={() => {
                          ...
                          <h1 className='text-lg text-black font-semibold'>Nombre:</h1>
                          {rowModify === 'lastName' ? (
                            <textarea onKeyDown={(event) => handleKeyPress(event, changes, rowModify)} ref={textareaRef} onMouseEnter={handleTextArea} onBlur={handleTextArea} autoFocus defaultValue={patient.lastName} className="text-teal-500 bg-teal-600 bg-opacity-50 flex h-16 font-semibold focus:bg-teal-600 focus:bg-opacity-50 focus:outline-transparent focus:text-black text-lg overflow-auto w-full ml-4 mr-4" onChange={(event) => setChanges(event.target.value)} />
                          ) : (
                            <p className='ml-2 text-gray-700 text-xl w-4/6 overflow-auto'>{patient.lastName}</p>
                          )}
                          <div className='ml-auto'>
                        ...
                        <div onClick={() => {
                          ...
                          <h1 className='text-lg text-black font-semibold'>DNI:</h1>
                          {rowModify === 'dni' ? (
                            <textarea onKeyDown={(event) => handleKeyPress(event, changes, rowModify)} ref={textareaRef} onMouseEnter={handleTextArea} onBlur={handleTextArea} autoFocus defaultValue={patient.dni} className="text-teal-500 bg-teal-600 bg-opacity-50 flex h-16 font-semibold focus:bg-teal-600 focus:bg-opacity-50 focus:outline-transparent focus:text-black text-lg overflow-auto w-full ml-4 mr-4" onChange={(event) => setChanges(event.target.value)} />
                          ) : (
                            <p className='ml-2 text-gray-700 text-xl w-4/6 overflow-auto'>{patient.dni}</p>
                          )}
                          <div className='ml-auto'>
                        ...
                        <div onClick={() => {
                          ...
                          <h1 className='text-lg text-black font-semibold'>Domicilio:</h1>
                          {rowModify === 'address' ? (
                            <textarea onKeyDown={(event) => handleKeyPress(event, changes, rowModify)} ref={textareaRef} onMouseEnter={handleTextArea} onBlur={handleTextArea} autoFocus defaultValue={patient.address} className="text-teal-500 bg-teal-600 bg-opacity-50 flex h-16 font-semibold focus:bg-teal-600 focus:bg-opacity-50 focus:outline-transparent focus:text-black text-lg overflow-auto w-full ml-4 mr-4" onChange={(event) => setChanges(event.target.value)} />
                          ) : (
                            <p className='ml-2 text-gray-700 text-xl w-4/6 overflow-auto'>{patient.address}</p>
                          )}
                          <div className='ml-auto'>
                        ...
                        <div onClick={() => {
                          ...
                          <h1 className='text-lg text-black font-semibold'>Nacimiento:</h1>
                          {rowModify === 'birthDate' ? (
                            <textarea onKeyDown={(event) => handleKeyPress(event, changes, rowModify)} ref={textareaRef} onMouseEnter={handleTextArea} onBlur={handleTextArea} autoFocus defaultValue={patient.birthDate} className="text-teal-500 bg-teal-600 bg-opacity-50 flex h-16 font-semibold focus:bg-teal-600 focus:bg-opacity-50 focus:outline-transparent focus:text-black text-lg overflow-auto w-full ml-4 mr-4" onChange={(event) => setChanges(event.target.value)} />
                          ) : (
                            <p className='ml-2 text-gray-700 text-xl w-4/6 overflow-auto'>{patient.birthDate}</p>
                          )}
                          <div className='ml-auto'>
                        ...
                        <div onClick={() => {
                          ...
                          <h1 className='text-lg text-black font-semibold'>Género:</h1>
                          {rowModify === 'gender' ? (
                            <textarea onKeyDown={(event) => handleKeyPress(event, changes, rowModify)} ref={textareaRef} onMouseEnter={handleTextArea} onBlur={handleTextArea} autoFocus defaultValue={patient.gender} className="text-teal-500 bg-teal-600 bg-opacity-50 flex h-16 font-semibold focus:bg-teal-600 focus:bg-opacity-50 focus:outline-transparent focus:text-black text-lg overflow-auto w-full ml-4 mr-4" onChange={(event) => setChanges(event.target.value)} />
                          ) : (
                            <p className='ml-2 text-gray-700 text-xl w-4/6 overflow-auto'>{patient.gender}</p>
                          )}
                          <div className='ml-auto'>
                  ...
                  <div className='w-1/2'>
                    <div className='mr-4 border-4 rounded-3xl border-gray-600 bg-gray-400 bg-opacity-30 shadow-xl w-full relative'>
                      <div className="absolute top-0 right-0 mt-2 mr-2 bg-teal-950 bg-opacity-80 rounded-full w-24 h-24 flex justify-center items-center shadow-xl">
                      ...
                      <div className='mb-4'>
                        <div className='flex'>
                          <div>
                            <h1 className='mb-3 text-2xl font-semibold text-teal-600 border-b-4 border-r-2 border-gray-600 bg-gray-400 bg-opacity-30 w-full rounded-t-2xl rounded-br-3xl px-6 pt-1 pb-1 select-none'>CONTACTO</h1>
                            <div onClick={() => {
                              if (rowModify !== 'num') {
                                setRowModify('num');
                              }
                              ...
                              <h1 className='text-lg text-black font-semibold'>Núm.Telefono:</h1>
                              {rowModify === 'num' ? (
                                <textarea onKeyDown={(event) => handleKeyPress(event, changes, rowModify)} ref={textareaRef} onMouseEnter={handleTextArea} onBlur={handleTextArea} autoFocus defaultValue={patient.num} className="text-teal-500 bg-teal-600 bg-opacity-50 flex h-16 font-semibold focus:bg-teal-600 focus:bg-opacity-50 focus:outline-transparent focus:text-black text-lg overflow-auto w-full ml-4 mr-4" onChange={(event) => setChanges(event.target.value)} />
                              ) : (
                                <p className='ml-2 text-gray-700 text-xl w-4/6 overflow-auto'>{patient.num}</p>
                              )}
                              <div className='ml-auto'>
                            ...
                            <div onClick={() => {
                              ...
                              <h1 className='text-lg text-black font-semibold'>Correo:</h1>
                              {rowModify === 'email' ? (
                                <textarea onKeyDown={(event) => handleKeyPress(event, changes, rowModify)} ref={textareaRef} onMouseEnter={handleTextArea} onBlur={handleTextArea} autoFocus defaultValue={patient.email} className="text-teal-500 bg-teal-600 bg-opacity-50 flex h-16 font-semibold focus:bg-teal-600 focus:bg-opacity-50 focus:outline-transparent focus:text-black text-lg overflow-auto w-full ml-4 mr-4" onChange={(event) => setChanges(event.target.value)} />
                              ) : (
                                <p className='ml-2 text-gray-700 text-xl w-4/6 overflow-auto'>{patient.email}</p>
                              )}
                              <div className='ml-auto'>
                    ...
                    <div className='mr-4 border-4 rounded-3xl border-gray-600 bg-gray-400 bg-opacity-30 shadow-xl w-full mt-4 relative'>
                      <div className="absolute top-0 right-0 mt-2 mr-2 bg-teal-950 bg-opacity-80 rounded-full w-24 h-24 flex justify-center items-center shadow-xl">
                      ...
                      <div className='mb-4'>
                        <div className='flex'>
                          <div>
                            <h1 className='mb-3 text-2xl font-semibold text-teal-600 border-b-4 border-r-2 border-gray-600 bg-gray-400 bg-opacity-30 w-full rounded-t-2xl rounded-br-3xl px-6 pt-1 pb-1 select-none'>SALUD</h1>
                            <div onClick={() => {
                              if (rowModify !== 'obra') {
                                setRowModify('obra');
                              }
                              ...
                              <h1 className='text-lg text-black font-semibold'>ObraSocial:</h1>
                              {rowModify === 'obra' ? (
                                <textarea onKeyDown={(event) => handleKeyPress(event, changes, rowModify)} ref={textareaRef} onMouseEnter={handleTextArea} onBlur={handleTextArea} autoFocus defaultValue={patient.obra} className="text-teal-500 bg-teal-600 bg-opacity-50 flex h-16 font-semibold focus:bg-teal-600 focus:bg-opacity-50 focus:outline-transparent focus:text-black text-lg overflow-auto w-full ml-4 mr-4" onChange={(event) => setChanges(event.target.value)} />
                              ) : (
                                <p className='ml-2 text-gray-700 text-xl w-4/6 overflow-auto'>{patient.obra}</p>
                              )}
                              <div className='ml-auto'>
                            ...
                            <div onClick={() => {
                              ...
                              <h1 className='text-lg text-black font-semibold'>Plan:</h1>
                              {rowModify === 'plan' ? (
                                <textarea onKeyDown={(event) => handleKeyPress(event, changes, rowModify)} ref={textareaRef} onMouseEnter={handleTextArea} onBlur={handleTextArea} autoFocus defaultValue={patient.plan} className="text-teal-500 bg-teal-600 bg-opacity-50 flex h-16 font-semibold focus:bg-teal-600 focus:bg-opacity-50 focus:outline-transparent focus:text-black text-lg overflow-auto w-full ml-4 mr-4" onChange={(event) => setChanges(event.target.value)} />
                              ) : (
                                <p className='ml-2 text-gray-700 text-xl w-4/6 overflow-auto'>{patient.plan}</p>
                              )}
                              <div className='ml-auto'>
                            ...
                            <div onClick={() => {
                              ...
                              <h1 className='text-lg text-black font-semibold'>Núm.Afiliado:</h1>
                              {rowModify === 'affiliateNum' ? (
                                <textarea onKeyDown={(event) => handleKeyPress(event, changes, rowModify)} ref={textareaRef} onMouseEnter={handleTextArea} onBlur={handleTextArea} autoFocus defaultValue={patient.affiliateNum} className="text-teal-500 bg-teal-600 bg-opacity-50 flex h-16 font-semibold focus:bg-teal-600 focus:bg-opacity-50 focus:outline-transparent focus:text-black text-lg overflow-auto w-full ml-4 mr-4" onChange={(event) => setChanges(event.target.value)} />
                              ) : (
                                <p className='ml-2 text-gray-700 text-xl w-4/6 overflow-auto'>{patient.affiliateNum}</p>
                              )}
                              <div className='ml-auto'>
                ...
                <div className="flex justify-center">
                  <div className='mt-4 border-4 rounded-3xl border-gray-600 bg-gray-400 bg-opacity-30 shadow-xl w-[42rem] relative'>
                    <div className='flex'>
                      <div onClick={() => setOpenAlert(true)} className="text-center border-opacity-25 transition duration-200 ml-1 mr-1 mt-1 mb-1 w-full cursor-pointer hover:text-white hover:bg-red-900 hover:bg-opacity-70 rounded-2xl px-2 py-1 text-black text-xl font-medium">
