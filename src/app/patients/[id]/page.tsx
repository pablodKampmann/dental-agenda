          ...
          <div className='ml-2 p-4 mt-16 mr-2 relative'>
            ...
            {patient && (
              <div>
                ...
                <div onMouseEnter={() => setOpenInfo(true)} onMouseLeave={() => setOpenInfo(false)} className="hover:scale-125 transition duration-100 w-7 -translate-y-5 mr-2 ml-auto">
                  <FaQuestionCircle className="text-teal-600 cursor-pointer" size={26} />
                  {openInfo ? (
                    <div className="fixed top-0 -translate-x-[340px] mr-2 bg-gray-400 border-2 border-gray-600 rounded-lg px-2 py-1 text-xs w-80 ">
                ...
                <div className='flex'>
                  <div className='mr-4 border-2 rounded-3xl border-gray-600 bg-gray-400 bg-opacity-30 shadow-xl w-1/2'>
                    <div className="absolute top-0 right-0 mt-2 mr-2 bg-teal-950 bg-opacity-80 rounded-full w-20 h-20 flex justify-center items-center shadow-xl">
                      ...
                      <div>
                        ...
                        <div onClick={() => {
                          ...
                          {rowModify === 'gender' ? (
                            ...
                            <p className='ml-2 text-gray-700 text-lg w-4/6 overflow-auto'>{patient.gender}</p>
                          )}
                          <div className='ml-auto'>
                  ...
                  <div className='w-1/2'>
                    <div className='mr-4 border-2 rounded-3xl border-gray-600 bg-gray-400 bg-opacity-30 shadow-xl w-full '>
                      <div className="absolute top-0 right-0 mt-2 mr-2 bg-teal-950 bg-opacity-80 rounded-full w-20 h-20 flex justify-center items-center shadow-xl">
                    ...
                    <div className='mr-4 border-2 rounded-3xl border-gray-600 bg-gray-400 bg-opacity-30 shadow-xl w-full mt-4 '>
                      <div className="absolute top-0 right-0 mt-2 mr-2 bg-teal-950 bg-opacity-80 rounded-full w-20 h-20 flex justify-center items-center shadow-xl">
