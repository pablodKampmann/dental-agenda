                ...
                <div className='h-full py-2'>
                    ...
                    {openAlert === 'delete' && (
                        <div className='absolute inset-0 backdrop-blur-sm ml-56 z-10'>
                            <Alert onCloseAlert={() => setOpenAlert('')} onSuccess={() => { setOpenAlert(''); updatePractices(); setShowResult('good-delete-practice') }} action={'Eliminar Práctica'} firstProp={'¿Estás seguro/a de que deseas eliminar esta práctica?'} secondProp={practiceName} thirdProp={price} fourthProp={id} fifthProp={chapterName} />
                        </div>
                    )}
