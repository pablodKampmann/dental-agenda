        ...
        <div className="h-full py-2">
          {openAlert === "delete" && (
            <div className="absolute inset-0 backdrop-blur-sm ml-56 z-10">
              <Alert
                ...
                onSuccess={() => { setOpenAlert(""); updatePractices(); setShowResult("good-delete-practice"); }}
          ...
          <div className="ml-2 mr-2 p-4">
            <div className="flex justify-between select-none">
              ...
              <button
                onClick={() => { setOpenCreatePractice(!openCreatePractice); setId(null); setPrice(null); setOpenFormPercentages(false); setPracticeName(null); setLoading(false); }}
              ...
              >
                {openCreatePractice ? (
                  <div className="flex justify-center items-center"><ImCancelCircle className="mr-2" size={24} />Cancelar</div>
                ) : (
                  <div className="flex justify-center items-center"><HiFolderAdd className="mr-2" size={28} />Agregar Práctica</div>
                )}
              </button>
            </div>
          </div>
