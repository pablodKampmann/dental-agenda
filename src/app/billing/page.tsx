...
export default function Page() {
  ...
  function formattedIdFromRoman(numberInRoman: string) {
    ...
    const formattedDecimal =
      decimalValue < 10 ? `0${decimalValue}` : `${decimalValue}`;
                      ...
                      >
                        <td className="pl-4 px-4   whitespace-nowrap border-r-2 border-gray-600 w-16">
                          <div className="text-center  text-white items-center justify-center flex rounded-full w-fit bg-teal-600 text-sm font-semibold">
                            <p className="ml-1.5 mr-1.5">
                              {formattedIdFromRoman(chapterNum)}.{practice.id}
                            </p>
                          </div>
                        </td>
                        ...
                        {openPriceEdit[index] ? (
                            ...
                            <div className="flex justify-between items-center">
                              <div className="flex justify-center items-center">
                                ...
                                <input
                                  ...
                                  autoFocus
                                  onKeyDown={(event) =>
                                    handleKeyPress(event, practice.id)
                                  }
                              ...
                              <div className="flex">
                                <FaRegCircleCheck
                                  ...
                                  className=" mr-1 cursor-pointer hover:scale-125 transition duration-150 hover:text-white  text-black "
                                />
                                <FaRegCircleXmark
                                  size={28}
                                  onClick={cancelEdit}
                                  className=" ml-1 cursor-pointer hover:scale-125 transition duration-150 hover:text-white  text-black "
                                />
                              </div>
                            </div>
                          </td>
                          ...
                          <td
                            ...
                            className="px-5 whitespace-nowrap w-auto  text-black group  hover:bg-teal-600 py-4 cursor-pointer transition duration-150 hover:text-white"
                          >
                            <div className="flex justify-between items-center">
                        ...
                        >
                          <button>
                            <MdDelete
                              size={24}
                              className="group-hover:scale-125 transform mt-2 ml-0.5 transition duration-150"
                            />
                          </button>
                        </td>
                      </tr>
              ...
              {openCreatePractice ? (
                <div className="overflow-hidden">
                  <form
                    ...
                    className="relative w-[400px] mr-6 animate-move-from-right-form"
                  >
                    <div className="w-full border-2 border-gray-600 relative  bg-gray-300 bg-opacity-30 shadow-lg rounded-lg ">
                      ...
                      <div className=" pb-4 px-4">
                        <div className="flex justify-between ">
                          ...
                          <div className="flex flex-col mt-1 w-full mx-2">
                            <div className="flex">
                              <label className="text-black select-none text-lg ml-2">
                                Precio
                              </label>
                            </div>
                            <div className="flex justify-center items-center">
                      ...
                      <div className="mt-2 px-4 pb-4 flex justify-center items-center select-none text-base">
                        <button
                          ...
                          className="bg-red-900 hover:text-lg h-12 hover:bg-red-800 font-semibold flex justify-center items-center w-full text-red-200 hover:text-white mx-2  rounded-md focus:outline-none transition duration-200"
                        >
                          CANCELAR
                        </button>
                        <button
                          type="submit"
                          className="bg-teal-600 hover:bg-teal-500 font-semibold hover:text-lg flex justify-center h-12  items-center w-full text-teal-950 hover:text-white mx-2 rounded-md focus:outline-none transition duration-200"
                        >
                          {loading ? (
                            <div className="flex justify-center items-center ">
                              <ClipLoader
                ...
                <div className="overflow-hidden  w-1/5">
                  <div
                    className={`${openFormPercentages ? "h-fit" : "h-fit"} animate-move-from-right-form transition-all text-black border-2 duration-500 ease border-gray-600 ml-auto mr-6 shadow-lg rounded-lg  select-none bg-gray-300 bg-opacity-30`}
                  >
                    {openFormPercentages ? (
                      <div className=" flex  p-4 pt-6 flex-col justify-center items-center">
                        ...
                        <div className="flex mt-16 text-xl font-medium w-full">
                          <button
                            ...
                            className="mr-1.5 py-1 bg-red-600 hover:bg-opacity-70 hover:transition hover:duration-250 hover:text-gray-100 text-red-900 bg-opacity-50 rounded-lg w-full shadow-lg"
                          >
                            NO
                          </button>
                          <button
                            onClick={handleIncreaseOrDecrease}
                            className="ml-1.5 py-1 bg-teal-600 hover:bg-opacity-70 hover:transition hover:duration-200 hover:text-gray-100 text-teal-900 bg-opacity-50 rounded-lg w-full shadow-lg"
                          >
                      ...
                      <div
                        className={`${chapterData.length > 0 ? "" : " pointer-events-none "} `}
                      >
                        <h1
                          className={`${chapterData.length > 0 ? " " : "line-through"} bg-teal-600 flex justify-center items-center  px-1 text-center  text-white font-semibold text-xl py-2 border-b-2 border-gray-600 rounded-t-md`}
                        >
                          AUMENTAR TODO
                        </h1>
                        <div className="flex font-medium transition">
                          <button
                            onClick={() => {
                              setPercentageVisible("+5%");
                              setPercentage(0.05);
                              setOpenFormPercentages(true);
                            }}
                            className="hover:bg-teal-600 w-1/2 hover:duration-150 border-r-2 py-2 border-b-2 border-gray-600"
                          >
                            +5%
                          </button>
                          <button
                            onClick={() => {
                              setPercentageVisible("+10%");
                              setPercentage(0.1);
                              setOpenFormPercentages(true);
                            }}
                            className="hover:bg-teal-600 w-1/2 hover:duration-150 border-b-2 py-2 border-gray-600"
                          >
                            +10%
                          </button>
                        </div>
                        ...
                        {openPercentageEdit === "increase" ? (
                          ...
                          <button
                            onClick={() => {
                              setOpenPercentageEdit("increase");
                            }}
                            className="font-medium hover:bg-teal-600 w-full hover:duration-150 border-b-2 py-2 border-gray-600"
                          >
                            Personalizar +X%
                          </button>
                        )}
                        <h1
                          className={`${chapterData.length > 0 ? " " : "line-through"} flex justify-center items-center bg-teal-600 text-center px-1  text-white font-semibold text-xl py-2 border-b-2 border-gray-600`}
                        >
                          DISMINUIR TODO
                        </h1>
                        <div className="flex font-medium transition">
                          <button
                            ...
                            className="hover:bg-red-800 w-1/2 hover:duration-150 border-r-2 py-2 border-b-2 border-gray-600"
                          >
                            -5%
                          </button>
                          <button
                            ...
                            className="hover:bg-red-800 w-1/2 hover:duration-150 border-b-2 py-2 border-gray-600"
                          >
                            -10%
                          </button>
                        </div>
                        <div className="flex font-medium transition">
                          <button
                            ...
                            className="hover:bg-red-800 w-1/2 hover:duration-150 border-r-2 py-2 rounded-bl-md border-gray-600"
                          >
                            -15%
                          </button>
                          <button
                            ...
                            className="hover:bg-red-800 w-1/2  hover:duration-150 py-2 rounded-br-md border-gray-600"
                          >
                            -20%
                          </button>
                        </div>
